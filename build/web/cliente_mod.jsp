    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title">Registro de Nuevo Cliente</h1>
			    <hr class="mb-4">
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                <h3 class="section-title">Datos y privacidad</h3>
		                <div class="section-intro">Formulario para ingresar un nuevo cliente. Cada grupo de formulario requerido tiene un estado de validación que se puede activar al intentar enviar el formulario sin completarlo. <a href="help.html">Learn more</a></div>
	                </div>
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    <%
                                                        Cliente cliente = (Cliente) miSession.getAttribute("datosCliente");
                                                        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
                                                        String fecha_nac = formatter.format(cliente.getFecha_nac());
                                                        
                                                    %>
						    <div class="app-card-body">
                                                        <form class="settings-form row" action="SvClienteModificar" method="GET">
                                                            <input type="hidden" name="id" value="<%=cliente.getId_persona()%>" required>
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="setting-input-1" name="nombre" value="<%= cliente.getNombre() %>" placeholder="Steve" required>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <label for="setting-input-2" class="form-label">Apellido</label>
                                                                <input type="text" class="form-control" id="setting-input-2" name="apellido" value="<%= cliente.getApellido() %>" placeholder="Doe" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="setting-input-3" class="form-label">Email</label>
                                                                <input type="email" class="form-control" id="setting-input-3" name="email" value="<%= cliente.getEmail()%>" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="setting-input-11" class="form-label">Celular</label>
                                                                <input type="text" class="form-control" id="setting-input-11" name="celular" value="<%= cliente.getCelular()%>" required>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <label for="setting-input-4" class="form-label">Nacionalidad</label>
                                                                <input type="text" class="form-control" id="setting-input-4" name="nacionalidad" value="<%= cliente.getNacionalidad()%>" required>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <label for="setting-input-5" class="form-label">Dirección</label>
                                                                <input type="text" class="form-control" id="setting-input-5" name="direccion" value="<%= cliente.getDireccion()%>" required>
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="setting-input-7" name="dni" value="<%= cliente.getDni()%>" required>
                                                            </div>

                                                            <button type="submit" class="btn app-btn-primary" >Guardar Cliente</button>
                                                        </form>
						    </div><!--//app-card-body-->
