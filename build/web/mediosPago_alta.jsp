...
<html lang="es"> 
<head>
    <title>Agregar Nuevo Medio de Pago</title>
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title">Registro de Nuevo Medio de Pago</h1>
			    <hr class="mb-4">
	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
                                                        <form class="settings-form row" action="SvMediosPagoAlta" method="POST">
								    <div class="col-md-6 mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="setting-input-1" name="nombre" value="Efectivo" required>
                                                                    </div>
                                                                    <div class="col-md-6 mb-3">
                                                                        <label for="setting-input-2" class="form-label">Comision</label>
                                                                        <input type="text" class="form-control" id="setting-input-2" name="comision" required>
                                                                    </div>
                                                                
                                                                    <button type="submit" class="btn app-btn-primary" >Guardar Medio de Pago</button>
							    </form>
						    </div><!--//app-card-body-->
