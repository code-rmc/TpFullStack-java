...
<html lang="es"> 
<head>
    <title>Lista - Paquetes Turisticos</title>
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Lista de Paquetes</h1>
				    </div>
				    <div class="col-auto">
		  ...
		  <path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
						    ...
						    <div class="app-card-body">
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												<th class="cell">Codigo de Paquete</th>
												<th class="cell">Nombre</th>
												<th class="cell">Lista de Servicio</th>
												<th class="cell">Costo de Paquete</th>
												<th class="cell">Accion</th>
											</tr>
										</thead>
										<tbody>
                                                                                        <%
                                                                                            List<PaqueteTuristico> listaPaq = (List) miSession.getAttribute("listaPaquete");
                                                                                            
                                                                                            if(listaPaq.size() != 0){
                                                                                                for (PaqueteTuristico paquete : listaPaq) {
                                                                                        %>
											<tr>
                                                                                            <td class="cell"><%= paquete.getCodigo_paquete()%></td>
                                                                                            <td class="cell"><span class="truncate"><%= paquete.getNombre()%></span></td>
                                                                                            <td class="cell">
                                                                                                <ul class="app-menu footer-menu list-unstyled">
                                                                                                <% for(Servicio servicio : paquete.getLista_servicios_incluidos()){ %>
                                                                                                <li class="nav-item"><%= servicio.getNombre()%></li>
                                                                                                <%}%>
                                                                                                </ul>
                                                                                            </td>
                                                                                            <td class="cell"><span><%= paquete.getCosto_paquete()%></span></td>
                                                                                            <td class="cell row g-1 align-items-center">
                                                                                                <button type="button" class="btn-sm app-btn-secondary" data-bs-toggle="modal" data-bs-target="#modificarPaq">
                                                                                                    Modificar
                                                                                                </button>
                                                                                                <button type="button" class="btn-sm app-btn-secondary" data-bs-toggle="modal" data-bs-target="#eliminarPaq">
                                                                                                    Borrar
                                                                                                </button>
                                                                                            </td>
											</tr>
            ...
            <!-- Modal Modificacion-->
            <div class="modal fade" id="modificarPaq" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                            ...
                            <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-12 col-lg-auto text-center text-lg-start">
                                            ...
                                            <ul class="notification-meta list-inline mb-0">
                                                    <li class="list-inline-item">Paquete Turistico</li>
                  ...
                  <div class="modal-body">
                      <form class="settings-form row elimModForm" action="SvPaqueteModificar" method="GET">
            ...
            <!-- Modal Borrado -->
            <div class="modal fade" id="eliminarPaq" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <div class="app-card app-card-notification">
                  ...
                  <div class="modal-body">
                    <form class="settings-form row elimModForm" action="SvPaqueteEliminar" method="POST">
                        <input type="text" class="form-control" name="id" hidden>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Nombre</label>
                            <input type="text" class="form-control" name="nombre" disabled>
    ...
    <script>
        ...
        tBody.addEventListener("click", (e) => {
            if(e.target.tagName === "BUTTON")
            {
                ...
                formInput[3].value = datosTabla[0].textContent;
                formInput[4].value = datosTabla[1].textContent;
                formInput[5].value = datosTabla[3].textContent;
