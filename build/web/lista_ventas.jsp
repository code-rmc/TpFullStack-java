    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		  ...
		  <path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Paquete turistico</th>
                                                                                        ...
                                                                                        <% 
                                                                                            ...
                                                                                            if(listaVentas.size() != 0){
                                                                                                for (Venta venta : listaVentas) {
                                                                                                    ...
                                                                                                    String fecha_venta = formatter.format(venta.getFecha_venta());
                                                                                                    String cliente = venta.getCliente().getApellido() + " " + venta.getCliente().getNombre();
                                                                                                    String paquete = "--------";
                                                                                                    String servicio = "--------";
                                                                                                    if (venta.getPaq_Turistico() != null) {
                                                                                                        paquete = venta.getPaq_Turistico().getNombre();
                                                                                                    } else {
                                                                                                        servicio = venta.getServicio().getNombre();
                                                                                                    }
                                                                                        %>
											<tr>
                                                                                            <td class="cell"><%= venta.getNum_venta()%></td>
                                                                                            <td class="cell"><span class="truncate"><%= paquete%></span></td>
                                                                                            <td class="cell"><%= servicio%></td>
                                                                                            <td class="cell"><span class="badge bg-success"><%= cliente%></span></td>
                                                                                            <td class="cell"><span><%= fecha_venta%></span></td>
                                                                                            <td class="cell">$<%= venta.getTotal()%></td>
                                                                                            <td class="cell row g-1 align-items-center">
                                                                                                <button type="button" class="btn-sm app-btn-secondary" data-bs-toggle="modal" data-bs-target="#modificarVenta">
                                                                                                    Modificar
                                                                                                </button>
                                                                                                <button type="button" class="btn-sm app-btn-secondary" data-bs-toggle="modal" data-bs-target="#eliminarVenta">
                                                                                                    Borrar
                                                                                                </button>
                                                                                            </td>
											</tr>
            ...
            <!-- Modal Modificacion-->
            <div class="modal fade" id="modificarVenta" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  ...
                  <div class="modal-body">
                      <form class="settings-form row elimModForm" action="" method="GET">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="paquete" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Nombre Servicio</label>
                            <input type="text" class="form-control" name="servicio" disabled>
                        </div>
                        <div class="col-md-4 mb-3">
            ...
            <div class="modal fade" id="eliminarVenta" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="settings-form row elimModForm" action="SvVentaEliminar" method="POST">
                        <input type="text" class="form-control" name="id" hidden>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Nombre Paquete</label>
                            <input type="text" class="form-control" name="paquete" disabled>
