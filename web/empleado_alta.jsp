	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    <div class="app-card-body">
                                                        <form class="settings-form row" action="SvEmpleadoAlta" method="POST">
...
<circle cx="8" cy="4.5" r="1"/>
                                                                        ...
                                                                        <input type="text" class="form-control" id="setting-input-1" name="nombre" placeholder="Steve" required>
                                                                    </div>
                                                                    <div class="col-md-6 mb-3">
                                                                        <label for="setting-input-2" class="form-label">Apellido</label>
                                                                        <input type="text" class="form-control" id="setting-input-2" name="apellido" placeholder="Doe" required>
                                                                    </div>
								    <div class="mb-3">
                                                                        <label for="setting-input-3" class="form-label">Email</label>
                                                                        <input type="email" class="form-control" id="setting-input-3" name="email" value="hello@companywebsite.com" required>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="setting-input-11" class="form-label">Celular</label>
                                                                        <input type="text" class="form-control" id="setting-input-11" name="celular" value="1155442233" required>
                                                                    </div>
                                                                    <div class="col-md-6 mb-3">
                                                                        <label for="setting-input-4" class="form-label">Nacionalidad</label>
                                                                        <input type="text" class="form-control" id="setting-input-4" name="nacionalidad" value="Argentina" required>
                                                                    </div>
                                                                    <div class="col-md-6 mb-3">
                                                                        <label for="setting-input-5" class="form-label">Dirección</label>
                                                                        <input type="text" class="form-control" id="setting-input-5" name="direccion" value="Lorem Ipsum Ltd." required>
                                                                    </div>
                                                                    <div class="col-md-6 mb-3">
                                                                        <label for="setting-input-6" class="form-label">Fecha de Nacimiento</label>
                                                                        <input type="date" class="form-control" id="setting-input-6" name="fecha_nac" required>
                                                                    </div>
                                                                    <div class="col-md-6 mb-3">
                                                                        <label for="setting-input-7" class="form-label">DNI</label>
                                                                        <input type="text" class="form-control" id="setting-input-7" name="dni" value="55123678" required>
                                                                    </div>
							    ...
							    <div class="item py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
                                                                                ...
                                                                                <input type="text" class="form-control" id="setting-input-8" name="user" required>
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
                                                                                ...
                                                                                <input type="text" class="form-control" id="setting-input-9" name="pass" required>
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
						    </div><!--//app-card-body-->
							    ...
							    <div class="item py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
                                                                                ...
                                                                                <input type="text" class="form-control" id="setting-input-10" name="cargo" required>
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
                                                                                ...
                                                                                <input type="text" class="form-control" id="setting-input-11" name="sueldo" required>
									    </div><!--//col-->
								    </div><!--//row-->
							    </div><!--//item-->
						    </div><!--//app-card-body-->
