	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
                                                        <form class="settings-form row" action="SvClienteAlta" method="POST">
...
<circle cx="8" cy="4.5" r="1"/>
								    ...
								    <div class="mb-3">
                                                                    ...
                                                                    <div class="col-md-6 mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="setting-input-5" name="direccion" value="Lorem Ipsum Ltd. 2222" required>
                                                                    </div>
                                                                    <div class="col-md-6 mb-3">
