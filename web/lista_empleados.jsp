	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Lista de Empleados</h1>
				    </div>
				    <div class="col-auto">
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
                                                                                        ...
                                                                                        <% 
                                                                                            ...
                                                                                            List<Empleado> listaEmpl = (List) miSession.getAttribute("listaEmpleados");

                                                                                            if(listaEmpl.size() != 0){
                                                                                                for (Empleado empleado : listaEmpl) {
                                                                                                    SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
                                                                                                    String fecha_nac = formatter.format(empleado.getFecha_nac());
                                                                                        %>
											<tr>
												<td class="cell"><%= empleado.getId_persona() %></td>
												<td class="cell"><span class="truncate"><%= empleado.getNombre() %></span></td>
												<td class="cell"><%=empleado.getApellido() %></td>
												<td class="cell"><span class="cell-data"><%= empleado.getDireccion() %></span><span class="note">03:16 AM</span></td>
												<td class="cell"><span class="badge bg-warning"><%= empleado.getDni() %></span></td>
												<td class="cell"><%= fecha_nac %> </td>
												<td class="cell"><%= empleado.getNacionalidad() %> </td>
												<td class="cell"><%= empleado.getCelular() %></td>
												<td class="cell"><%= empleado.getEmail() %></td>
												<td class="cell"><%= empleado.getCargo() %></td>
												<td class="cell"><%= empleado.getSueldo() %></td>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                            ...
                            <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-12 col-lg-auto text-center text-lg-start">
                                            ...
                                            <ul class="notification-meta list-inline mb-0">
                                                    <li class="list-inline-item">Empleado</li>
                  ...
                  <div class="modal-body">
                      <form class="settings-form row elimModForm" action="SvEmpleadoModificar" method="POST">
            ...
            <div class="modal fade" id="eliminarEmp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="settings-form row elimModForm" action="SvEmpleadoEliminar" method="POST">
                        <input type="text" class="form-control" name="id" hidden>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Nombre</label>
                            <input type="text" class="form-control" name="nombre" disabled>
