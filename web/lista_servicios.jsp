	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Lista de Servicios</h1>
				    </div>
				    <div class="col-auto">
		  ...
		  <path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Descripción Breve</th>
												<th class="cell">Destino Servicio</th>
												<th class="cell">Fecha de Servicio</th>
												<th class="cell">Costo de Servicio</th>
										...
										<tbody>
                                                                                        <% 
                                                                                            List<Servicio> listaServ = (List) miSession.getAttribute("listaServicio");
                                                                                            
                                                                                            if(listaServ.size() != 0){
                                                                                                for (Servicio servicio : listaServ) {
                                                                                                    SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
                                                                                                    String fecha_serv = formatter.format(servicio.getFecha_servicio());
                                                                                        %>
											<tr>
                                                                                            <td class="cell"><%= servicio.getCodigo_servicio()%></td>
												<td class="cell"><span class="truncate"><%= servicio.getNombre()%></span></td>
												<td class="cell"><%= servicio.getDescripcion_breve()%></td>
												<td class="cell"><span class="badge bg-success"><%= servicio.getDestino_servicio()%></span></td>
												<td class="cell"><span><%= fecha_serv%></span><span class="note">2:16 PM</span></td>
												<td class="cell">$<%= servicio.getCosto_servicio()%></td>
												<td class="cell row g-1 align-items-center">
                                                                                                    <button type="button" class="btn-sm app-btn-secondary" data-bs-toggle="modal" data-bs-target="#modificarEmp">
                                                                                                        Modificar
                                                                                                    </button>
                                                                                                    <button type="button" class="btn-sm app-btn-secondary" data-bs-toggle="modal" data-bs-target="#eliminarEmp">
                                                                                                        Borrar
                                                                                                    </button>
                                                                                                </td>
											</tr>
            ...
            <!-- Modal Modificacion-->
            <div class="modal fade" id="modificarEmp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                            ...
                            <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-12 col-lg-auto text-center text-lg-start">
                                            ...
                                            <ul class="notification-meta list-inline mb-0">
                                                    <li class="list-inline-item">Servicio</li>
                  ...
                  <div class="modal-body">
                      <form class="settings-form row elimModForm" action="" method="GET">
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Destino Servicio</label>
            ...
            <!-- Modal Borrado -->
            <div class="modal fade" id="eliminarEmp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <div class="app-card app-card-notification">
                        <div class="app-card-header py-3 border-0">
                            <div class="row g-3 align-items-center">
                                    <div class="col-12 col-lg-auto text-center text-lg-start">						        
                                    <div class="app-icon-holder" style="background: #fdeded;
color: #bf1d1d;">
                  ...
                  <div class="modal-body">
                    <form class="settings-form row elimModForm" action="" method="POST">
                        <input type="text" class="form-control" name="id" hidden>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Nombre</label>
                            <input type="text" class="form-control" name="nombre" disabled>
    ...
    <script>
        ...
        tBody.addEventListener("click", (e) => {
            if(e.target.tagName === "BUTTON")
            {
                ...
                formInput[2].value = datosTabla[3].textContent;
                formInput[3].value = datosTabla[5].textContent;
                formInput[4].value = datosTabla[0].textContent;
                formInput[5].value = datosTabla[1].textContent;
                formInput[6].value = datosTabla[3].textContent;
                formInput[7].value = datosTabla[5].textContent;
            }
        });
    </script>
</body>
