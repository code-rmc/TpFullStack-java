...
<html lang="es"> 
<head>
    <title>Lista - Medios de pago</title>
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		  ...
		  <path fill-rule="evenodd" d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
						    ...
						    <div class="app-card-body">
							    <div>
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
                                                                                        <% 
                                                                                            List<MediosPago> listaMp = (List) request.getSession().getAttribute("listaMediosPago");
                                                                                            if(listaMp.size() != 0){
                                                                                                for (MediosPago mp : listaMp) {
                                                                                        %>
											<tr>
                                                                                            <td class="cell"><%= mp.getId_medio()%></td>
                                                                                            <td class="cell"><span class="truncate"><%= mp.getMedioPago()%></span></td>
                                                                                            <td class="cell"><%= mp.getComision()%>%</td>
                                                                                            <td class="cell row g-1 align-items-center">
                                                                                                <button type="button" class="btn-sm app-btn-secondary" data-bs-toggle="modal" data-bs-target="#modificarMp">
                                                                                                    Modificar
                                                                                                </button>
                                                                                                <button type="button" class="btn-sm app-btn-secondary" data-bs-toggle="modal" data-bs-target="#eliminarMp">
                                                                                                    Borrar
                                                                                                </button>
                                                                                            </td>
											</tr>
            ...
            <!-- Modal Modificacion-->
            <div class="modal fade" id="modificarMp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                            ...
                            <div class="row g-3 align-items-center">
                                    ...
                                    <div class="col-12 col-lg-auto text-center text-lg-start">
                                            ...
                                            <ul class="notification-meta list-inline mb-0">
                                                    <li class="list-inline-item">Medio de Pago</li>
                  ...
                  <div class="modal-body">
                      <form class="settings-form row elimModForm" action="SvMediosPagoModificar" method="GET">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="comision" disabled>
                        </div>
            ...
            <!-- Modal Borrado -->
            <div class="modal fade" id="eliminarMp" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <div class="app-card app-card-notification">
                  ...
                  <div class="modal-body">
                    <form class="settings-form row elimModForm" action="SvMediosPagoEliminar" method="POST">
                        <input type="text" class="form-control" name="id" hidden>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Nombre</label>
                            <input type="text" class="form-control" name="nombre" disabled>
    ...
    <script>
        ...
        tBody.addEventListener("click", (e) => {
            if(e.target.tagName === "BUTTON")
            {
                ...
                formInput[5].value = datosTabla[2].textContent;
            }
        });
    </script>
</body>
